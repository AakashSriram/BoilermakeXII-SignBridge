            ...
            <main className="flex flex-grow flex-col lg:flex-row items-center justify-center p-4">
                ...
                <div className="w-full lg:w-1/2 p-2 flex justify-center">
                    <div className="relative w-full max-w-3xl rounded-3xl overflow-hidden shadow-2xl">
                        ...
                        />
                        {isGeneratingLipSync && !finalLipsyncedLink && (
                        ...
                        <div className="lg:w-1/3 w-full mt-6 lg:mt-0 lg:ml-6 flex flex-col justify-center">
                            <div className="bg-white bg-opacity-10 p-6 rounded-2xl shadow-2xl border border-white border-opacity-30">
                                ...
                                >
                                    ...
                                    {demographics.race_confidence
                                        ? (demographics.race_confidence * 100).toFixed(2)
                                        : "N/A"}
                                    %)
                                </motion.p>
                                <motion.p
                                ...
                                >
                                    ...
                                    {demographics.predicted_ethnicity || "N/A"} (
                                    {demographics.ethnicity_confidence
                                        ? (demographics.ethnicity_confidence * 100).toFixed(2)
                                        : "N/A"}
                                    %)
                                </motion.p>
                                <motion.p
                                ...
                                >
                                    ...
                                    (
                                    {demographics.gender_confidence
                                        ? (demographics.gender_confidence * 100).toFixed(2)
                                        : "N/A"}
                                    %)
                                </motion.p>
                            </div>
